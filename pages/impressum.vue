<template>
  <section class="mx-auto max-w-5xl px-3 py-3 bg-white">
    <section class="bilder">
      Foto von <a href="https://unsplash.com/de/@shawnanggg?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">shawnanggg</a> auf <a href="https://unsplash.com/de/fotos/brauner-und-grauer-betonladen-nmpW_WwwVSc?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Unsplash</a>

    </section>
    <h2><strong>Angaben gemäß § 5 TMG</strong></h2>
    <p>Jonathan Martz Software Entwicklung<br> Othestrasse 2<br> 51702 Bergneustadt <br><br></p>
    <h2><strong>Vertreten durch:</strong></h2>
    <p>Jonathan Martz<br><br></p>
    <h2><strong>Kontakt:</strong></h2>
    <p>E-Mail: <a href="mailto:impresum@jonathan-martz.de">impressum@jonathan-martz.de </a><br><br></p>
    ...
    umgehend entfernen. <br><br><strong>Haftung für Links</strong><br><br> Unser Angebot enthält Links zu externen
    Webseiten Dritter, auf deren Inhalte wir keinen Einfluss haben. Deshalb können wir für diese fremden Inhalte auch
    keine Gewähr übernehmen. Für die Inhalte der verlinkten Seiten ist stets der jeweilige Anbieter oder Betreiber der
    Seiten verantwortlich. Die verlinkten Seiten wurden zum Zeitpunkt der Verlinkung auf mögliche Rechtsverstöße
    überprüft. Rechtswidrige Inhalte waren zum Zeitpunkt der Verlinkung nicht erkennbar. Eine permanente inhaltliche
    Kontrolle der verlinkten Seiten ist jedoch ohne konkrete Anhaltspunkte einer Rechtsverletzung nicht zumutbar. Bei
    Bekanntwerden von Rechtsverletzungen werden wir derartige Links umgehend entfernen.
    <br><br><strong>Urheberrecht</strong><br><br> Die durch die Seitenbetreiber erstellten Inhalte und Werke auf diesen
    Seiten unterliegen dem deutschen Urheberrecht. Die Vervielfältigung, Bearbeitung, Verbreitung und jede Art der
    ...
    derartige Inhalte umgehend entfernen. <br><br><strong>Datenschutz</strong><br><br> Die Nutzung unserer Webseite ist
    in der Regel ohne Angabe personenbezogener Daten möglich. Soweit auf unseren Seiten personenbezogene Daten
    (beispielsweise Name, Anschrift oder eMail-Adressen) erhoben werden, erfolgt dies, soweit möglich, stets auf
    freiwilliger Basis. Diese Daten werden ohne Ihre ausdrückliche Zustimmung nicht an Dritte weitergegeben. <br> Wir
    weisen darauf hin, dass die Datenübertragung im Internet (z.B. bei der Kommunikation per E-Mail) Sicherheitslücken
    aufweisen kann. Ein lückenloser Schutz der Daten vor dem Zugriff durch Dritte ist nicht möglich. <br> Der Nutzung
    von im Rahmen der Impressumspflicht veröffentlichten Kontaktdaten durch Dritte zur Übersendung von nicht
    ...
    Werbeinformationen, etwa durch Spam-Mails, vor.<br></p>
  ...
  <p>Der Provider der Seiten erhebt und speichert automatisch Informationen in so genannten Server-Log-Dateien, die Ihr
    Browser automatisch an uns übermittelt. Dies sind:<br><br> · Browsertyp und Browserversion<br> · verwendetes
    Betriebssystem<br> · Referrer URL<br> · Hostname des zugreifenden Rechners<br> · Uhrzeit der Serveranfrage<br> ·
    IP-Adresse<br><br><br> Eine Zusammenführung dieser Daten mit anderen Datenquellen wird nicht vorgenommen.<br>
